<script lang="ts">
	...
	import { breakDownBar } from '../../store/toogleModal.svelte';
	...
	let data = [
		{
			...
			step_description: '20 columns mapped',
			updated_at: '12 Aug'
		},
		{
			step_name: 'Data Formating',
			step_description: 'Process Name/Formula',
			updated_at: '12 Aug'
		},
		{
			step_name: 'New Fields Added',
			step_description: 'Process Name/Formula',
			updated_at: '12 Aug'
		},
		{
			step_name: 'RBI Guidelines',
			step_description: 'Process Name/Formula',
			updated_at: '12 Aug'
		}
	];
